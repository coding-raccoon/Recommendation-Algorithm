...
class TopNExperiment(BaseExperiment):
    """
    ...
    def __init__(self, dataloader, M, Model_Info, figsize=(8, 6)):
        ...
        """
        super(TopNExperiment, self).__init__(dataloader, M, Model_Info)
        self.mean_metrics = {}
    ...
    def conduct(self):
        ...
        for model_name in self.dict_metrics.keys():
            ...
            self.mean_metrics[model_name] = {'recall': [], 'precision': [], 'coverage': [], 'popularity': []}
    ...
    def show_result(self):
        ...
        for i, model_name in enumerate(self.dict_metrics.keys()):
            ...
            for j, key in enumerate(['recall', 'precision', 'coverage']):
        ...
        for i, metrics in enumerate(["recall", "precision", "coverage", "popularity"]):
            plt.subplot(2, 2, i+1)
